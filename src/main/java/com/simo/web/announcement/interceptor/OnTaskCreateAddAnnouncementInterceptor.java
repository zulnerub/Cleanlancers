...
@Component
public class OnTaskCreateAddAnnouncementInterceptor implements HandlerInterceptor {
    private final AnnouncementServiceImpl announcementService;
    private final UserServiceImpl userService;

    public OnTaskCreateAddAnnouncementInterceptor(AnnouncementServiceImpl announcementService, UserServiceImpl userService) {
